                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Update 3rd Holder</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">View Application</a>
                                        </li>
                                        <li class="breadcrumb-item active">Update 3rd Holder</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-xxl-9">
                            <div class="card mt-xxl-n5">
                                <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0">Applicant 3rd Holder Information</h4>
                                </div>
                                <div class="card-body p-4">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                            <form
                                                action="<?php echo base_url('updateThHolder/' . $item->applicant_no); ?>"
                                                method="post">
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        ...
                                                        <span class="text-danger">
                                                            <input type="text" class="form-control" name="thr_applicant"
                                                                placeholder="Enter Name of Applicant"
                                                                value="<?php echo $item->thr_applicant; ?>">
                                                            <span class="text-danger">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="thr_adhar"
                                                                    placeholder="Adhar Card Number"
                                                                    value="<?php echo $item->thr_adhar; ?>">
                                                                <span class="text-danger">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="thr_pan"
                                                                    placeholder="Pan Card Number"
                                                                    value="<?php echo $item->thr_pan; ?>">
                                                                <span class="text-danger">
                                                    ...
                                                    <div class="mb-3 pb-2">
                                                        ...
                                                        <textarea class="form-control" name="thr_address"
                                                            placeholder="Enter your full Address"
                                                            rows="3"><?php echo $item->thr_address; ?></textarea>
                                                        <span class="text-danger">
